...
\midrule
OT  & 20 & OT-A &1{,}804 & ---$^\dagger$ & 0.05 & --- \\
OT  & 20 & OT-B &3{,}449 & ---$^\dagger$ & 0.05 & --- \\
OT  & 20 & OT-C &1{,}854 & ---$^\dagger$ & 0.05 & --- \\
\bottomrule
\multicolumn{7}{l}{\scriptsize $^\dagger$ASP skipped (cannot prove optimality at 20 components within 120\,s).}
\end{tabular}}
\end{table}
...
$220\times$ speedup. At 20~components (OpenTitan), ASP cannot prove
optimality within a 120\,s timeout; CP-SAT proves optimality in
under 0.1\,s.  This scalability boundary marks where CP-SAT becomes
...
20 & ---$^\dagger$ & 0.05 & --- \\
\bottomrule
\multicolumn{4}{l}{\scriptsize $^\dagger$ASP skipped; cannot prove optimality at 20 components.}
\end{tabular}
\end{table}
...
$10\times$ at~3, and $220\times$ at~8; at 20~components
ASP cannot prove optimality within its timeout. For rapid parameter
...
\begin{figure}[t]
    ...
    \caption{Mean solve time vs.\ component count (log scale, 1--8
    components). ASP cannot prove optimality at 20~components.}
    \label{fig:runtime}
\end{figure}
