...
0.003\,s, giving a third independent solver validation.
...
strong evidence of formulation correctness across three independent
solver paradigms.
...
This formulation is less extensible than ASP but provides an
independent optimality certificate from a mature commercial solver.
...
The ILP comparison validates that the CP-SAT optima are correct
from a third independent solver paradigm.
...
Gurobi ILP confirms the OT optima in under 0.003\,s, providing
independent validation from a commercial MIP solver.
