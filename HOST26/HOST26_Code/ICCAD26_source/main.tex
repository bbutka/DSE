...
greedy and local-search heuristics match the optimum
under two profiles but miss by 5\% under the tightest.
\end{abstract}
...
weaker feature.  An impact-ordered greedy would assign ZT to crypto
engines first, yet the optimizer exploits redundancy coverage instead.
This kind of multi-constraint, redundancy-aware assignment benefits
from exact optimization.
