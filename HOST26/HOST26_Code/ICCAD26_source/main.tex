...
\multicolumn{7}{l}{\scriptsize An ILP formulation (Gurobi) confirms the same objectives on all instances ($<$0.003\,s).}
\end{tabular}}
\end{table}
...
A third solver, Gurobi ILP, confirms every reported optimum in under
0.003\,s, providing independent validation from a commercial MIP solver.
