...
if not ot_a_list or "asp_security" not in ot_a_list[0]:
...
sec_data = [sec_map[ot_a["asp_security"][c]] for c in components_order]
log_data = [log_map[ot_a["asp_logging"][c]] for c in components_order]
